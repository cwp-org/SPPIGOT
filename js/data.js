// Auto-generated from SPPIGOT_04292026.xlsx
const SPPIGOT_DATA = {
  "operations": [
    {
      "name": "Parks and Landscaping",
      "description": "The management and care of trees, grass, and other vegetation at public parks, golf courses, conservation areas, community open space, and other publicly-owned properties. Specifically, this includes planting, mowing, trimming, fertilizer/pesticide application, organic debris management, irrigation, and waste management. ",
      "pollutants": "Nutrients (nitrogen, phosphorus) from fertilizers; pesticides; fuel  and hydrocarbons from gas-powered landscape equipment",
      "opportunities": "Protecting natural lands from conversion to other uses prevents pollution associated with urban stormwater runoff. Transitioning to native landscapes reduces runoff and requires less fertilizer/pesticides/water, while low-maintenance lawn care practices also reduce organic waste and the need for chemical applications/irrigation. Transitioning to electric maintenance equipment reduces oil and fuel pollution from spills."
    },
    {
      "name": "Winter Road Maintenance",
      "description": "Planning and deployment of ice prevention and deicing operations across public transportation infrastructure to ensure safe travel in winter conditions. These activities impact salt storage facilities, roads, parking lots, bridges, sidewalks, and other public transit spaces.",
      "pollutants": "Chloride from road salt",
      "opportunities": "Process changes, equipment investments and calibration, road salt alternatives, and training on best practices can all help to minimize the amount of chloride entering waterways while still meeting public safety needs. "
    },
    {
    ...
    },
    {
      ...
      "description": "Powering, maintaining, cleaning, repairing, and storing publicly-owned fleets, such as buses, street sweepers, construction equipment, police cars, fire trucks, municipal vehicles, and school buses. ",
      "pollutants": "Solvents (e.g., degreasers, paint thinners), oil and grease, fuels, detergents, and other toxic compounds associated with vehicle cleaning, maintenance, and repair.",
      "opportunities": "Conducting regular vehicle inspections minimize spills and leaks, while changing materials or processes reduces stormwater pollution potential. Converting fleets from gasoline-powered to electric also reduces oil and fuel pollution from spills."
    },
    {
      "name": "Public Facility Management",
      "description": "Operating and maintaining outdoor hardscape portions of publicly-owned facilities, such as municipal buildings, public works yards, and public swimming pools.",
      "pollutants": "Various, including detergents and solvents used for cleaning",
      "opportunities": "Changing the materials or processes used to clean buildings, pavements, and other hardscape components can reduce the amount of toxic pollutants used, reducing stormwater pollution potential. Inventorying stored products can help to minimize overpurchase and overuse of chemicals, further reducing pollution potential."
    },
    {
  ...
  "questions": [
    {
      "operation": "Parks and Landscaping",
    ...
    {
      "operation": "Parks and Landscaping",
      "question": "Does your community use battery-powered landscape equipment instead of gas-powered?",
    ...
    {
      "operation": "Parks and Landscaping",
      "question": "Has your community installed hydration refill stations at parks and other public properties?",
      "action": "Install hydration refill stations at public parks and facilities to encourage use of refillable bottles and reduce trash pollution.",
      "benefits": [
        "Prevents trash pollution"
      ]
    },
    {
      "operation": "Parks and Landscaping",
      "question": "Does your community use Safer Choice-certified athletic field paint?",
      "action": "Use less toxic paint for athletic field striping. EPA's Safer Choice website can be used to find certified products.",
      "benefits": [
        "Prevents VOCs pollution",
        "Prevents other toxic pollutants",
        "Reduces greenhouse gas emissions"
    ...
    {
      "operation": "Winter Road Maintenance",
    ...
    {
      "operation": "Procurement & Regulations",
      "question": "Has your community exacted a ban on the provision of single-use plastics (e.g., plastic bags, straws, bottles, expanded polystyrene foam containers) to consumers?",
      "action": "Ban all single-use plastics, or certain types of single use plastics such as plastic bags or bottles, to address common sources of trash pollution in your community.",
      "benefits": [
        "Prevents trash pollution"
      ]
    },
    {
      "operation": "Procurement & Regulations",
      "question": "Does your community have regulatory measures in place to ensure that single-use plastic products are not provided free of charge at the point of sale to the final consumer?",
      "action": "Enact legislation requiring retail establishments to charge consumers a set amount for single use plastic products such as plastic bags.",
      "benefits": [
        "Prevents trash pollution"
      ]
    },
    {
      "operation": "Procurement & Regulations",
      "question": "Has your community enacted a ban on the use of gas-powered lawn and landscaping equipment, such as leaf blowers, string trimmers, hedge trimmers, edgers, pole saws, chainsaws and mowers?",
    ...
    {
      "operation": "Procurement & Regulations",
      "question": "Has your community enacted legislation that prohibits the sale of new gas-powered lawn and landscaping equipment?",
    ...
    {
      "operation": "Procurement & Regulations",
      "question": "Has your community enacted a ban on the sale of coal-tar based pavement sealcoat?",
      "action": "Enact legislation prohibiting the sale of coal tar-based pavement sealant to limit the amount of Polycyclic Aromatic Hydrocarbons entering stormwater and waterbodies.",
      "benefits": [
        "Prevents PAHs pollution"
      ]
    },
    ...
    {
      "operation": "Procurement & Regulations",
      "question": "Does your community have a green purchasing policy that commits to environmentally preferable purchasing using standards and procedures for selecting products based on environmental criteria?",
    ...
    {
      "operation": "Vehicle & Fleet Management",
    ...
    {
      "operation": "Vehicle & Fleet Management",
      "question": "Does your community use a system for cleaning vehicle parts that does not require solvents?",
    ...
    {
      "operation": "Vehicle & Fleet Management",
      "question": "Does your community use Safer-Choice certified degreasers for cleaning vehicle parts?",
    ...
    {
      "operation": "Vehicle & Fleet Management",
      "question": "Does your community regularly inspect and maintain fleet vehicles to minimize leaking contaminants?",
      "action": "Establish procedures to regularly inspect and maintain fleet vehicles to minimize pollutant leaks (e.g., fuel, brake fluid, antifreeze, oil)",
      "benefits": [
        "Prevents VOCs pollution",
        "Prevents PAHs pollution",
        "Prevents petroleum hydrocarbons pollution",
    ...
    {
      "operation": "Vehicle & Fleet Management",
      "question": "Does your community change fleet vehicle fluids on an as-needed basis, using inspection results?",
      "action": "Change vehicle fluids on an as-needed basis rather than a fixed schedule to avoid unnessary maintanance and associated chamical use/spills.",
      "benefits": [
        "Prevents VOCs pollution",
        "Prevents PAHs pollution",
        "Prevents petroleum hydrocarbons pollution",
    ...
    {
      "operation": "Vehicle & Fleet Management",
      "question": "Does your community have procedures in place to replace gas powered vehicles with hybrid or electric vehicles?",
    ...
    {
      "operation": "Public Facility Management",
    ...
    {
      "operation": "Public Facility Management",
      "question": "Does your community use water-based paints and coatings or alternative paints instead of oil-based ones for outdoor use where appropriate?",
    ...
    {
      "operation": "Construction & Maintenance",
      "question": "Does your community have regulations in place to minimize clearing, erosion and sedimentation during public construction, maintenance, and repair projects? ",
      "action": "Adopt a local erosion and sediment control ordinance to minimize soil erosion during construction activities. ",
      "benefits": [
        "Prevents sediment pollution"
      ]
    },
    {
      "operation": "Construction & Maintenance",
      "question": "Does your community regularly inspect and maintain construction and maintenance equipment to prevent leaking contaminants?",
      "action": "Establish procedures to regularly inspect and maintain construction and maintenance equipment to minimize pollutant leaks.",
      "benefits": [
        "Prevents VOCs pollution",
        "Prevents PAHs pollution",
        "Prevents petroleum hydrocarbons pollution",
    ...
    {
      "operation": "Construction & Maintenance",
      "question": "Does your community have a program in place to regularly inspect, maintain, and repair stormwater management facilities and infrastructure?",
      "action": "Implement procedures to regularly inspect, maintain, and repair stormwater management facilities and infrastructure to prevent failures that contribute to erosion or other pollution discharge.",
      "benefits": [
        "Prevents sediment pollution",
        "Saves money"
      ]
    ...
    {
      "operation": "Construction & Maintenance",
      "question": "Use less toxic alternatives to coal tar-based pavement sealants for public projects.",
      "action": "Use alternatives to coal tar-based pavement sealants (e.g., coal tar-free asphalt emulsions, acrylics, bio-based sealers, polymer-modified emulsions) on public construction projects to reduce PAHs.",
      "benefits": [
        "Prevents PAHs pollution"
      ]
    },
    {
      "operation": "Construction & Maintenance",
      "question": "Does your community use water-based paints and coatings or alternative paints instead of oil-based ones for public road and parking lot striping where appropriate?",
      "action": "Consider water-based or alternative paint  (e.g., lime, milk protein, clay and earth-based pigments) and coatings where suitable to reduce toxic pollutants such as volatile organic compounds and eliminate the need for solvents for cleanup.",
      "benefits": [
        "Prevents VOCs pollution",
        "Prevents petroleum hydrocarbons pollution",
    ...
    {
      "operation": "Construction & Maintenance",
      "question": "Does your community maintain and enforce design and maintenance standards for public and private unpaved roads (i.e., dirt, gravel, native rock, or other non-durable surfacing)?",
      "action": "Integrate design and maintenance standards for upaved roads into the land development process.",
      "benefits": [
        "Prevents sediment pollution",
        "Saves money"
      ]
    ...
    {
      "operation": "Construction & Maintenance",
      "question": "Does your community have a program focused on inventory, inspection, and maintenance of unpaved roads?",
      "action": "Implement procedures to inventory existing unpaved roads, conduct regular inspections of their condition, and perform maintenance to prevent or address erosion problems.",
      "benefits": [
        "Prevents sediment pollution",
        "Saves money"
      ]
    ...
    {
      "operation": "Construction & Maintenance",
      "question": "Is your community working to bring existing roads into compliance with unpaved road standards (or otherwise address erosion on existing unpaved roads)?",
      "action": "Address the most severe erosion problems on unpaved roads through regrading, drainage improvements, and slope stabilization.",
      "benefits": [
        "Prevents sediment pollution"
      ]
    }
